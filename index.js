...
budy = (type === 'conversation') ? mek.message.conversation : (type === 'extendedTextMessage') ? mek.message.extendedTextMessage.text : ''
 ...
 let command = chats.split(/ +/g)[0];
    ...
    const q = args.join(" ");
			...
			mess = {
				wait: 'Proses sabar',
				nsfw: 'NSFW belum aktif follow ig @callang172',
...
INFO CREATOR BOT
*Nama : Aslam gwanteng*
*Instagram : @callang172*
*YouTube : SEPUTAR INTERNET*
*Link Yt : https://youtube.com/channel/UCY5u0qN7DmOzYlRyX1an7DQ*
*WhatsApp : wa.me/6285340783774*

-----------------------------------•

INFO BOT
*Nama Bot : ${namabot}*
*Author : Aslam gwanteng*
*Base : adakah pap*
*Library : Bailey*
...
• Allah Swt
• mamaku
• keluarga besar  beban keluarga (bk)
`
...
│➛*Nama Bot* : ${namabot}
│➛*Versi* : 1.0.0
│➛*Creator* : Aslam gwanteng
│➛*Youtube* : SEPUTAR INTERNET
╰┬────────────┈ ⳹
   │ *「HARGA SEWA 」* 
   │➛ *1 BULAN* : 10K
   │➛ *2 BULAN* : 15K   gratis masukin gc
   │➛ *4 BULAN* : 25K
   │ *「HARGA SCRIPT 」* 
...
case 'script':
case 'sc':
ngontol = `*SCRIPT BOT WA BAKAL UPDATE DI YT SEPUTAR INTERNET V4 NIH LINKNYA*\n*https://youtube.com/channel/UCY5u0qN7DmOzYlRyX1an7DQ*\n*V4 WORK DI HEROKU*`
reply (ngontol)
break
case 'donasi':
case 'donate':
...
KLO NGGAK MAU DONASI JAN KLIK MEMEK NAMBAH BEBAN AJAH
...
_${prefix}tahta_
`
sendButMessage(from, menu, '_*BY ASLAM GWANTENG*_', [
{buttonId: `${prefix}owner`, buttonText: {displayText: 'OWNER BOT:)'}, type: 1},
{buttonId: `${prefix}donasi`, buttonText: {displayText: 'DONASI BOT ;)'}, type: 1}
]);
break
...
case 'tagall':
                ...
                case 'request':
					...
					client.sendMessage('6285340783774@s.whatsapp.net', options, text, {quoted: mek})
					client.sendMessage('6285340783774@s.whatsapp.net', options, text, {quoted: mek})
					client.sendMessage('6285340783774@s.whatsapp.net', options, text, {quoted: mek})
				...
				case 'kick':
					...
					break
 //Ambil Case Kasih Credits Gw Dong : ASLAM GWANTENG
  case 'add':
  try {
  if (!isGroup) return reply(mess.only.group)
...
var menu = `
_*LIST MENU DOWNLOAD MENU*_
ITU YAH MENU DOWNLOADNYA KLO EROR JAN BACOT
_${prefix}welcome_
_${prefix}antilink_
_${prefix}promote_
_${prefix}demote_
...
break
case 'pinterest':
            if(!q) return reply('gambar apa memek?')
...
if (!isGroup) return reply(mess.only.group)
            ...
            contentText: `_© By ASLAM GWANTENG_`,
...
var menu = `
_*LIST DOSA MENU*_
INI DOSA YAH ADIK ADIK BY ASLAM GWANTENG
_${prefix}hentai_
_${prefix}anal_
_${prefix}futanari_
_${prefix}yuri_
...
var menu =`
_*LIST WIBU MENU*_
LU WIBU KAN AWOKWOKWOK BY ASLAM GWANTENG
_${prefix}loli_
_${prefix}waifu_
_${prefix}husbu_
_${prefix}milf_
